...
\begin{frame}{Original and Shiftd Features}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{scatter_plots.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}{Label Distribution in Train Set} 
    \vfill
    \centering
    \includegraphics[width=0.7\textwidth]{pairplot.pdf}
    \vfill
...
\begin{frame}{Label Distribution in Shifted Test Set}
    \begin{figure}
        \centering
        \vfill
        \includegraphics[width=0.7\textwidth]{pairplotshift.pdf}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{marginal_plots0.5.pdf}
        \includegraphics[width=0.9\textwidth]{marginal_plots1.0.pdf}
    \end{figure}
